...
# ---------- 默认配置 ----------
HYSTERIA_VERSION="v2.8.1"
DEFAULT_PORT=22222         # 自适应端口
AUTH_PASSWORD="wasdfasdgsgd,W-?af faswW1-9"   # 建议修改为复杂密码
CERT_FILE="cert.pem"
KEY_FILE="key.pem"
SNI="www.bing.com"
ALPN="h3"
...
print_connection_info() {
    ...
    echo "hysteria2://${AUTH_PASSWORD}@${IP}:${SERVER_PORT}?sni=${SNI}&alpn=${ALPN}&insecure=1#Hy2-Lunes"
    echo ""
    echo "📄 客户端配置文件:"
